...
public class MapActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Mapbox.getInstance(this, "pk.eyJ1IjoiY291bGRpaGF2ZXN1bXRlYSIsImEiOiJja2FwOXJ5dmUwMXlxMnF0NXp3ZW5zeDNyIn0.lGLiSnLCh2Rr4JzvDXBylg");
    ...
    public class PointTask extends AsyncTask<Style, Void, Style> {
        ...
        protected Style doInBackground(Style... styles) {
            ...
            origin = adressService.getPoint(from);
            destination = adressService.getPoint(to);
            return style;
        }
